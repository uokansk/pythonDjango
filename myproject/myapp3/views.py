...
class MonthPost(View):
    def get(self, request, year, month):
        ...
        return HttpResponse(f"Posts from {month} month/ {year} year<br>{text} ")
...
def post_detail(request, year, month, slug):
    ...
    post = {
        ...
        "month": month,
        "slug": slug,
        "title": "Кто быстрее создаёт списки в Python, list() или []", "content":
            "В процессе написания очередной программы задумался над тем, какой способ "
